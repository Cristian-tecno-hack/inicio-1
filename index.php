...
<!-- link al login: http://localhost/loginPHP/-->
<!-- link a la base de datos: http://localhost/phpmyadmin/db_structure.php?server=1&db=phplogin&table=usuarios -->
<!DOCTYPE html>
<html lang="en">
	<head>
					...
					<div class="col-sm-10 col-sm-offset-1">
						<div class="login-container">
							<div class="center">
								...
								<h4 class="blue" id="id-company-text">&copy; AnimeOtakuOnline</h4>
							</div>
									...
									<div class="widget-body">
										<div class="widget-main">
											...
											<div class="social-login center">
												<a href="https://www.youtube.com/channel/UC_abgLG-yd5sXZtAeCcZIYw" target="_blank" class="btn btn-danger">
